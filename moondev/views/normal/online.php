...
<div class="title-section">Mercado online</div>
<div class="title-sectionn" id="response_search">
    ...
    <div class="modal" id="modal-object-buy" style="display: none;">
        <div class="body-modal">
            ...
            <button class="btn-save" onclick="javascript:comprar();">Confirmar Compra</button>
        </div>
    </div>
</div>
<script>
